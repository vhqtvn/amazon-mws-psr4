...
/**
 * \Vhqtvn\AmazonMWS\Services\FBAInboundServiceMWS\Model\FbaInboundServiceMwsModelWeight
 * 
 * @property	float	$Value
 * @property	string	$Unit
 */
class FbaInboundServiceMwsModelWeight extends FbaInboundServiceMwsModel
{
