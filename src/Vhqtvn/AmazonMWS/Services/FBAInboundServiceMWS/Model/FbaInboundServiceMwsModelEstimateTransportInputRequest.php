...
/**
 * \Vhqtvn\AmazonMWS\Services\FBAInboundServiceMWS\Model\FbaInboundServiceMwsModelEstimateTransportInputRequest
 * 
 * @property	string	$SellerId
 * @property	string	$MWSAuthToken
 * @property	string	$ShipmentId
 */
class FbaInboundServiceMwsModelEstimateTransportInputRequest extends FbaInboundServiceMwsModel
{
