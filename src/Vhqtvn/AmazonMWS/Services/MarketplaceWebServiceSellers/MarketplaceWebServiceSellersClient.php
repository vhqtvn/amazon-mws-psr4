...
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceSellers\Model\MarketplaceWebServiceSellersModelGetServiceStatusRequest;
...
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceSellers\Model\MarketplaceWebServiceSellersModelListMarketplaceParticipationsRequest;
...
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceSellers\Model\MarketplaceWebServiceSellersModelListMarketplaceParticipationsByNextTokenRequest;
...
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceSellers\MarketplaceWebServiceSellersException;
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceSellers\Model\MarketplaceWebServiceSellersModelResponseHeaderMetadata;
/**
 * \Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceSellers\MarketplaceWebServiceSellersClient is an implementation of MarketplaceWebServiceSellers
 *
 */
class MarketplaceWebServiceSellersClient implements MarketplaceWebServiceSellersInterface
{
    ...
    /** @var array */
    private $_config = array('ServiceURL' => null, 'UserAgent' => 'MarketplaceWebServiceSellers PHP5 Library', 'SignatureVersion' => 2, 'SignatureMethod' => 'HmacSHA256', 'ProxyHost' => null, 'ProxyPort' => -1, 'ProxyUsername' => null, 'ProxyPassword' => null, 'MaxErrorRetry' => 3, 'Headers' => array());
    /**
     * Get Service Status
    ...
    {
        if (!$request instanceof MarketplaceWebServiceSellersModelGetServiceStatusRequest) {
            $request = new MarketplaceWebServiceSellersModelGetServiceStatusRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'GetServiceStatus';
        $httpResponse = $this->_invoke($parameters);
        $response = MarketplaceWebServiceSellersModelGetServiceStatusResponse::fromXML($httpResponse['ResponseBody']);
    ...
    {
        if (!$request instanceof MarketplaceWebServiceSellersModelListMarketplaceParticipationsRequest) {
            $request = new MarketplaceWebServiceSellersModelListMarketplaceParticipationsRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListMarketplaceParticipations';
        $httpResponse = $this->_invoke($parameters);
        $response = MarketplaceWebServiceSellersModelListMarketplaceParticipationsResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    {
        if (!$request instanceof MarketplaceWebServiceSellersModelListMarketplaceParticipationsByNextTokenRequest) {
            $request = new MarketplaceWebServiceSellersModelListMarketplaceParticipationsByNextTokenRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListMarketplaceParticipationsByNextToken';
        $httpResponse = $this->_invoke($parameters);
        $response = MarketplaceWebServiceSellersModelListMarketplaceParticipationsByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                throw new MarketplaceWebServiceSellersException(array('ErrorCode' => 'InvalidServiceURL', 'Message' => "Missing serviceUrl configuration value. You may obtain a list of valid MWS URLs by consulting the MWS Developer's Guide, or reviewing the sample code published along side this library."));
            }
            ...
            throw new MarketplaceWebServiceSellersException(array('Exception' => $t, 'Message' => $t->getMessage()));
        }
    }
    /**
    ...
    private function _reportAnyErrors($responseBody, $status, $responseHeaderMetadata, \Exception $e = null)
    {
        ...
        return new MarketplaceWebServiceSellersException($exProps);
    }
    /**
    ...
    private function _httpPost(array $parameters)
    {
        ...
        if ($response === false) {
            ...
            curl_close($ch);
            throw new MarketplaceWebServiceSellersException($exProps);
        }
        curl_close($ch);
    ...
    private function _extractResponseHeaderMetadata($rawHeaders)
    {
        ...
        return new MarketplaceWebServiceSellersModelResponseHeaderMetadata($headers['x-mws-request-id'], $headers['x-mws-response-context'], $headers['x-mws-timestamp'], $headers['x-mws-quota-max'], $headers['x-mws-quota-remaining'], $headers['x-mws-quota-resetsOn']);
    }
    /**
