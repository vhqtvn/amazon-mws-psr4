...
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\Model\MarketplaceWebServiceOrdersModelGetOrderRequest;
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\Model\MarketplaceWebServiceOrdersModelGetOrderResponse;
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\Model\MarketplaceWebServiceOrdersModelGetServiceStatusRequest;
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\Model\MarketplaceWebServiceOrdersModelGetServiceStatusResponse;
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\Model\MarketplaceWebServiceOrdersModelListOrderItemsRequest;
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\Model\MarketplaceWebServiceOrdersModelListOrderItemsResponse;
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\Model\MarketplaceWebServiceOrdersModelListOrderItemsByNextTokenRequest;
...
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\Model\MarketplaceWebServiceOrdersModelListOrdersRequest;
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\Model\MarketplaceWebServiceOrdersModelListOrdersResponse;
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\Model\MarketplaceWebServiceOrdersModelListOrdersByNextTokenRequest;
...
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\MarketplaceWebServiceOrdersException;
use Exception;
use Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\Model\MarketplaceWebServiceOrdersModelResponseHeaderMetadata;
/**
 * \Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\MarketplaceWebServiceOrdersClient is an implementation of MarketplaceWebServiceOrders
 *
 */
class MarketplaceWebServiceOrdersClient implements MarketplaceWebServiceOrdersInterface
{
    ...
    /** @var array */
    private $_config = array('ServiceURL' => null, 'UserAgent' => 'MarketplaceWebServiceOrders PHP5 Library', 'SignatureVersion' => 2, 'SignatureMethod' => 'HmacSHA256', 'ProxyHost' => null, 'ProxyPort' => -1, 'ProxyUsername' => null, 'ProxyPassword' => null, 'MaxErrorRetry' => 3, 'Headers' => array());
    /**
     * Get Order
    ...
    {
        if (!$request instanceof MarketplaceWebServiceOrdersModelGetOrderRequest) {
            $request = new MarketplaceWebServiceOrdersModelGetOrderRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'GetOrder';
        $httpResponse = $this->_invoke($parameters);
        $response = MarketplaceWebServiceOrdersModelGetOrderResponse::fromXML($httpResponse['ResponseBody']);
    ...
    {
        if (!$request instanceof MarketplaceWebServiceOrdersModelGetServiceStatusRequest) {
            $request = new MarketplaceWebServiceOrdersModelGetServiceStatusRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'GetServiceStatus';
        $httpResponse = $this->_invoke($parameters);
        $response = MarketplaceWebServiceOrdersModelGetServiceStatusResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    {
        if (!$request instanceof MarketplaceWebServiceOrdersModelListOrderItemsRequest) {
            $request = new MarketplaceWebServiceOrdersModelListOrderItemsRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListOrderItems';
        $httpResponse = $this->_invoke($parameters);
        $response = MarketplaceWebServiceOrdersModelListOrderItemsResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    {
        if (!$request instanceof MarketplaceWebServiceOrdersModelListOrderItemsByNextTokenRequest) {
            $request = new MarketplaceWebServiceOrdersModelListOrderItemsByNextTokenRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListOrderItemsByNextToken';
        $httpResponse = $this->_invoke($parameters);
        $response = MarketplaceWebServiceOrdersModelListOrderItemsByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    {
        if (!$request instanceof MarketplaceWebServiceOrdersModelListOrdersRequest) {
            $request = new MarketplaceWebServiceOrdersModelListOrdersRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListOrders';
        $httpResponse = $this->_invoke($parameters);
        $response = MarketplaceWebServiceOrdersModelListOrdersResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    {
        if (!$request instanceof MarketplaceWebServiceOrdersModelListOrdersByNextTokenRequest) {
            $request = new MarketplaceWebServiceOrdersModelListOrdersByNextTokenRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListOrdersByNextToken';
        $httpResponse = $this->_invoke($parameters);
        $response = MarketplaceWebServiceOrdersModelListOrdersByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                throw new MarketplaceWebServiceOrdersException(array('ErrorCode' => 'InvalidServiceURL', 'Message' => "Missing serviceUrl configuration value. You may obtain a list of valid MWS URLs by consulting the MWS Developer's Guide, or reviewing the sample code published along side this library."));
            }
            ...
            throw new MarketplaceWebServiceOrdersException(array('Exception' => $t, 'Message' => $t->getMessage()));
        }
    }
    /**
    ...
    private function _reportAnyErrors($responseBody, $status, $responseHeaderMetadata, \Exception $e = null)
    {
        ...
        return new MarketplaceWebServiceOrdersException($exProps);
    }
    /**
    ...
    private function _httpPost(array $parameters)
    {
        ...
        if ($response === false) {
            ...
            curl_close($ch);
            throw new MarketplaceWebServiceOrdersException($exProps);
        }
        curl_close($ch);
    ...
    private function _extractResponseHeaderMetadata($rawHeaders)
    {
        ...
        return new MarketplaceWebServiceOrdersModelResponseHeaderMetadata($headers['x-mws-request-id'], $headers['x-mws-response-context'], $headers['x-mws-timestamp'], $headers['x-mws-quota-max'], $headers['x-mws-quota-remaining'], $headers['x-mws-quota-resetsOn']);
    }
    /**
