...
/**
 * \Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceOrders\Model\MarketplaceWebServiceOrdersModelListOrdersByNextTokenRequest
 * 
 * @property	string	$SellerId
 * @property	string	$MWSAuthToken
 * @property	string	$NextToken
 */
class MarketplaceWebServiceOrdersModelListOrdersByNextTokenRequest extends MarketplaceWebServiceOrdersModel
{
