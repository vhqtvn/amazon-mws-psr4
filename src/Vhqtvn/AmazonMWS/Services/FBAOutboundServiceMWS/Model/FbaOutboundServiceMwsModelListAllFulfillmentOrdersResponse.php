 ...
 * 
 * @property	\Vhqtvn\AmazonMWS\Services\FBAOutboundServiceMWS\Model\FbaOutboundServiceMwsModelListAllFulfillmentOrdersResult	$ListAllFulfillmentOrdersResult
...
class FbaOutboundServiceMwsModelListAllFulfillmentOrdersResponse extends FbaOutboundServiceMwsModel
{
     ...
     *
     * @return \Vhqtvn\AmazonMWS\Services\FBAOutboundServiceMWS\Model\FbaOutboundServiceMwsModelListAllFulfillmentOrdersResult ListAllFulfillmentOrdersResult.
     */
     ...
     * @return $this
     */
    public function withListAllFulfillmentOrdersResult($ListAllFulfillmentOrdersResult)
    {
        $this->setListAllFulfillmentOrdersResult($ListAllFulfillmentOrdersResult);
        return $this;
    }
    /**
