 ...
 */
class FbaOutboundServiceMwsModelCreateFulfillmentOrderResponse extends FbaOutboundServiceMwsModel
{
    ...
    /**
     * Construct \Vhqtvn\AmazonMWS\Services\FBAOutboundServiceMWS\Model\FbaOutboundServiceMwsModelCreateFulfillmentOrderResponse from XML string
     * 
     * @param $xml
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FbaOutboundServiceMwsModelCreateFulfillmentOrderResponse($response->item(0));
        } else {
