...
use DOMXPath;
/**
 * \Vhqtvn\AmazonMWS\Services\FBAOutboundServiceMWS\Model\FbaOutboundServiceMwsModelCancelFulfillmentOrderResponse
 * 
 ...
 */
class FbaOutboundServiceMwsModelCancelFulfillmentOrderResponse extends FbaOutboundServiceMwsModel
{
    ...
    /**
     * Construct \Vhqtvn\AmazonMWS\Services\FBAOutboundServiceMWS\Model\FbaOutboundServiceMwsModelCancelFulfillmentOrderResponse from XML string
     * 
     * @param $xml
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FbaOutboundServiceMwsModelCancelFulfillmentOrderResponse($response->item(0));
        } else {
