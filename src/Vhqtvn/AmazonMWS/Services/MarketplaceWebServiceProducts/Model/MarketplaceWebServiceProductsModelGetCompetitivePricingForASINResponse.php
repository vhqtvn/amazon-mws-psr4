 ...
 * 
 * @property	\Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceProducts\Model\MarketplaceWebServiceProductsModelGetCompetitivePricingForASINResult[]	$GetCompetitivePricingForASINResult
...
class MarketplaceWebServiceProductsModelGetCompetitivePricingForASINResponse extends MarketplaceWebServiceProductsModel
{
    ...
    {
        foreach ($GetCompetitivePricingForASINResult_array as $GetCompetitivePricingForASINResult) {
