...
class MarketplaceWebServiceProductsModelGetProductCategoriesForSKUResponse extends MarketplaceWebServiceProductsModel
{
     ...
     *
     * @return \Vhqtvn\AmazonMWS\Services\MarketplaceWebServiceProducts\Model\MarketplaceWebServiceProductsModelGetProductCategoriesForSKUResult GetProductCategoriesForSKUResult.
     */
     ...
     * @return $this
     */
    public function withGetProductCategoriesForSKUResult($GetProductCategoriesForSKUResult)
    {
        $this->setGetProductCategoriesForSKUResult($GetProductCategoriesForSKUResult);
        return $this;
    }
    /**
