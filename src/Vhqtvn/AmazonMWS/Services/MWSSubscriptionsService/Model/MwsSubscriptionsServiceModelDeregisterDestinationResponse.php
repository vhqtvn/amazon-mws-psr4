...
class MwsSubscriptionsServiceModelDeregisterDestinationResponse extends MwsSubscriptionsServiceModel
{
     ...
     *
     * @return \Vhqtvn\AmazonMWS\Services\MWSSubscriptionsService\Model\MwsSubscriptionsServiceModelDeregisterDestinationResult DeregisterDestinationResult.
     */
     ...
     * @return $this
     */
    public function withDeregisterDestinationResult($DeregisterDestinationResult)
    {
        $this->setDeregisterDestinationResult($DeregisterDestinationResult);
        return $this;
    }
    /**
