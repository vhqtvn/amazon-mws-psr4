...
class MarketplaceWebServiceModelGetReportScheduleListResponse extends MarketplaceWebServiceModel
{
    ...
    {
        return $this->_fields['GetReportScheduleListResult']['FieldValue'];
    }
    /**
    ...
    {
        $this->_fields['GetReportScheduleListResult']['FieldValue'] = $value;
        return;
    }
    /**
    ...
    {
        return !is_null($this->_fields['GetReportScheduleListResult']['FieldValue']);
    }
    /**
