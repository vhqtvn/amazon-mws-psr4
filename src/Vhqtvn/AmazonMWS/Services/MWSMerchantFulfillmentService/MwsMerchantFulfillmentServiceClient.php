...
use Vhqtvn\AmazonMWS\Services\MWSMerchantFulfillmentService\Model\MwsMerchantFulfillmentServiceModelCancelShipmentRequest;
...
use Vhqtvn\AmazonMWS\Services\MWSMerchantFulfillmentService\Model\MwsMerchantFulfillmentServiceModelCreateShipmentRequest;
...
use Vhqtvn\AmazonMWS\Services\MWSMerchantFulfillmentService\Model\MwsMerchantFulfillmentServiceModelGetEligibleShippingServicesRequest;
...
use Vhqtvn\AmazonMWS\Services\MWSMerchantFulfillmentService\Model\MwsMerchantFulfillmentServiceModelGetShipmentRequest;
use Vhqtvn\AmazonMWS\Services\MWSMerchantFulfillmentService\Model\MwsMerchantFulfillmentServiceModelGetShipmentResponse;
use Vhqtvn\AmazonMWS\Services\MWSMerchantFulfillmentService\Model\MwsMerchantFulfillmentServiceModelGetServiceStatusRequest;
...
use Vhqtvn\AmazonMWS\Services\MWSMerchantFulfillmentService\MwsMerchantFulfillmentServiceException;
use Vhqtvn\AmazonMWS\Services\MWSMerchantFulfillmentService\Model\MwsMerchantFulfillmentServiceModelResponseHeaderMetadata;
/**
 * \Vhqtvn\AmazonMWS\Services\MWSMerchantFulfillmentService\MwsMerchantFulfillmentServiceClient is an implementation of MWSMerchantFulfillmentService
 *
 */
class MwsMerchantFulfillmentServiceClient implements MwsMerchantFulfillmentServiceInterface
{
    ...
    /** @var array */
    private $_config = array('ServiceURL' => null, 'UserAgent' => 'MWSMerchantFulfillmentService PHP5 Library', 'SignatureVersion' => 2, 'SignatureMethod' => 'HmacSHA256', 'ProxyHost' => null, 'ProxyPort' => -1, 'ProxyUsername' => null, 'ProxyPassword' => null, 'MaxErrorRetry' => 3, 'Headers' => array());
    /**
     * Cancel Shipment
    ...
    {
        if (!$request instanceof MwsMerchantFulfillmentServiceModelCancelShipmentRequest) {
            $request = new MwsMerchantFulfillmentServiceModelCancelShipmentRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'CancelShipment';
        $httpResponse = $this->_invoke($parameters);
        $response = MwsMerchantFulfillmentServiceModelCancelShipmentResponse::fromXML($httpResponse['ResponseBody']);
    ...
    {
        if (!$request instanceof MwsMerchantFulfillmentServiceModelCreateShipmentRequest) {
            $request = new MwsMerchantFulfillmentServiceModelCreateShipmentRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'CreateShipment';
        $httpResponse = $this->_invoke($parameters);
        $response = MwsMerchantFulfillmentServiceModelCreateShipmentResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    {
        if (!$request instanceof MwsMerchantFulfillmentServiceModelGetEligibleShippingServicesRequest) {
            $request = new MwsMerchantFulfillmentServiceModelGetEligibleShippingServicesRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'GetEligibleShippingServices';
        $httpResponse = $this->_invoke($parameters);
        $response = MwsMerchantFulfillmentServiceModelGetEligibleShippingServicesResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    {
        if (!$request instanceof MwsMerchantFulfillmentServiceModelGetShipmentRequest) {
            $request = new MwsMerchantFulfillmentServiceModelGetShipmentRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'GetShipment';
        $httpResponse = $this->_invoke($parameters);
        $response = MwsMerchantFulfillmentServiceModelGetShipmentResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    {
        if (!$request instanceof MwsMerchantFulfillmentServiceModelGetServiceStatusRequest) {
            $request = new MwsMerchantFulfillmentServiceModelGetServiceStatusRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'GetServiceStatus';
        $httpResponse = $this->_invoke($parameters);
        $response = MwsMerchantFulfillmentServiceModelGetServiceStatusResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                throw new MwsMerchantFulfillmentServiceException(array('ErrorCode' => 'InvalidServiceURL', 'Message' => "Missing serviceUrl configuration value. You may obtain a list of valid MWS URLs by consulting the MWS Developer's Guide, or reviewing the sample code published along side this library."));
            }
        ...
        } catch (MwsMerchantFulfillmentServiceException $se) {
            throw $se;
        } catch (\Exception $t) {
            throw new MwsMerchantFulfillmentServiceException(array('Exception' => $t, 'Message' => $t->getMessage()));
        }
    }
    /**
    ...
    private function _reportAnyErrors($responseBody, $status, $responseHeaderMetadata, \Exception $e = null)
    {
        ...
        return new MwsMerchantFulfillmentServiceException($exProps);
    }
    /**
    ...
    private function _httpPost(array $parameters)
    {
        ...
        if ($response === false) {
            ...
            curl_close($ch);
            throw new MwsMerchantFulfillmentServiceException($exProps);
        }
        curl_close($ch);
    ...
    private function _extractResponseHeaderMetadata($rawHeaders)
    {
        ...
        return new MwsMerchantFulfillmentServiceModelResponseHeaderMetadata($headers['x-mws-request-id'], $headers['x-mws-response-context'], $headers['x-mws-timestamp'], $headers['x-mws-quota-max'], $headers['x-mws-quota-remaining'], $headers['x-mws-quota-resetsOn']);
    }
    /**
