...
/**
 * \Vhqtvn\AmazonMWS\Services\MWSRecommendationsSectionService\Model\MwsRecommendationsSectionServiceModelGlobalSellingRecommendation
 * 
 ...
 * @property	int	$NumberOfOffersFulfilledByAmazon
 * @property	float	$AverageCustomerReview
 * @property	int	$NumberOfCustomerReviews
 * @property	\Vhqtvn\AmazonMWS\Services\MWSRecommendationsSectionService\Model\MwsRecommendationsSectionServiceModelItemDimensions	$ItemDimensions
 * @property	string	$RecommendationId
 * @property	string	$RecommendationReason
 */
class MwsRecommendationsSectionServiceModelGlobalSellingRecommendation extends MwsRecommendationsSectionServiceModel
{
    public function __construct($data = null)
    {
        $this->_fields = array('LastUpdated' => array('FieldValue' => null, 'FieldType' => 'string'), 'ItemIdentifier' => array('FieldValue' => null, 'FieldType' => \Vhqtvn\AmazonMWS\Services\MWSRecommendationsSectionService\Model\MwsRecommendationsSectionServiceModelProductIdentifier::class), 'ItemName' => array('FieldValue' => null, 'FieldType' => 'string'), 'BrandName' => array('FieldValue' => null, 'FieldType' => 'string'), 'ProductCategory' => array('FieldValue' => null, 'FieldType' => 'string'), 'SalesRank' => array('FieldValue' => null, 'FieldType' => 'int'), 'BuyboxPrice' => array('FieldValue' => null, 'FieldType' => \Vhqtvn\AmazonMWS\Services\MWSRecommendationsSectionService\Model\MwsRecommendationsSectionServiceModelPrice::class), 'NumberOfOffers' => array('FieldValue' => null, 'FieldType' => 'int'), 'NumberOfOffersFulfilledByAmazon' => array('FieldValue' => null, 'FieldType' => 'int'), 'AverageCustomerReview' => array('FieldValue' => null, 'FieldType' => 'float'), 'NumberOfCustomerReviews' => array('FieldValue' => null, 'FieldType' => 'int'), 'ItemDimensions' => array('FieldValue' => null, 'FieldType' => \Vhqtvn\AmazonMWS\Services\MWSRecommendationsSectionService\Model\MwsRecommendationsSectionServiceModelItemDimensions::class), 'RecommendationId' => array('FieldValue' => null, 'FieldType' => 'string'), 'RecommendationReason' => array('FieldValue' => null, 'FieldType' => 'string'));
     ...
     * @return $this
     */
    public function withNumberOfOffersFulfilledByAmazon($NumberOfOffersFulfilledByAmazon)
    {
        $this->setNumberOfOffersFulfilledByAmazon($NumberOfOffersFulfilledByAmazon);
        return $this;
    }
    /**
     ...
     * @return $this
     */
    public function withItemDimensions($ItemDimensions)
    {
