...
class MwsRecommendationsSectionServiceModelGetLastUpdatedTimeForRecommendationsRequest extends MwsRecommendationsSectionServiceModel
{
    ...
    {
        $this->_fields = array('MarketplaceId' => array('FieldValue' => null, 'FieldType' => 'string'), 'MWSAuthToken' => array('FieldValue' => null, 'FieldType' => 'string'), 'SellerId' => array('FieldValue' => null, 'FieldType' => 'string'));
