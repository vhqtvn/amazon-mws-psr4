...
use Vhqtvn\AmazonMWS\Services\MWSFinancesService\Model\MwsFinancesServiceModelListFinancialEventGroupsRequest;
use Vhqtvn\AmazonMWS\Services\MWSFinancesService\Model\MwsFinancesServiceModelListFinancialEventGroupsResponse;
use Vhqtvn\AmazonMWS\Services\MWSFinancesService\Model\MwsFinancesServiceModelListFinancialEventGroupsByNextTokenRequest;
...
use Vhqtvn\AmazonMWS\Services\MWSFinancesService\Model\MwsFinancesServiceModelListFinancialEventsRequest;
use Vhqtvn\AmazonMWS\Services\MWSFinancesService\Model\MwsFinancesServiceModelListFinancialEventsResponse;
use Vhqtvn\AmazonMWS\Services\MWSFinancesService\Model\MwsFinancesServiceModelListFinancialEventsByNextTokenRequest;
use Vhqtvn\AmazonMWS\Services\MWSFinancesService\Model\MwsFinancesServiceModelListFinancialEventsByNextTokenResponse;
use Vhqtvn\AmazonMWS\Services\MWSFinancesService\Model\MwsFinancesServiceModelGetServiceStatusRequest;
 ...
 *
 */
class MwsFinancesServiceClient implements MwsFinancesServiceInterface
{
    ...
    /** @var array */
    private $_config = array('ServiceURL' => null, 'UserAgent' => 'MWSFinancesService PHP5 Library', 'SignatureVersion' => 2, 'SignatureMethod' => 'HmacSHA256', 'ProxyHost' => null, 'ProxyPort' => -1, 'ProxyUsername' => null, 'ProxyPassword' => null, 'MaxErrorRetry' => 3, 'Headers' => array());
    /**
    ...
    {
        if (!$request instanceof MwsFinancesServiceModelListFinancialEventGroupsRequest) {
            $request = new MwsFinancesServiceModelListFinancialEventGroupsRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListFinancialEventGroups';
        $httpResponse = $this->_invoke($parameters);
        $response = MwsFinancesServiceModelListFinancialEventGroupsResponse::fromXML($httpResponse['ResponseBody']);
    ...
    {
        if (!$request instanceof MwsFinancesServiceModelListFinancialEventGroupsByNextTokenRequest) {
            $request = new MwsFinancesServiceModelListFinancialEventGroupsByNextTokenRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListFinancialEventGroupsByNextToken';
        $httpResponse = $this->_invoke($parameters);
        $response = MwsFinancesServiceModelListFinancialEventGroupsByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    {
        if (!$request instanceof MwsFinancesServiceModelListFinancialEventsRequest) {
            $request = new MwsFinancesServiceModelListFinancialEventsRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListFinancialEvents';
        $httpResponse = $this->_invoke($parameters);
        $response = MwsFinancesServiceModelListFinancialEventsResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    {
        if (!$request instanceof MwsFinancesServiceModelListFinancialEventsByNextTokenRequest) {
            $request = new MwsFinancesServiceModelListFinancialEventsByNextTokenRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListFinancialEventsByNextToken';
        $httpResponse = $this->_invoke($parameters);
        $response = MwsFinancesServiceModelListFinancialEventsByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    {
        if (!$request instanceof MwsFinancesServiceModelGetServiceStatusRequest) {
            $request = new MwsFinancesServiceModelGetServiceStatusRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'GetServiceStatus';
        $httpResponse = $this->_invoke($parameters);
        $response = MwsFinancesServiceModelGetServiceStatusResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                throw new MwsFinancesServiceException(array('ErrorCode' => 'InvalidServiceURL', 'Message' => "Missing serviceUrl configuration value. You may obtain a list of valid MWS URLs by consulting the MWS Developer's Guide, or reviewing the sample code published along side this library."));
            }
        ...
        } catch (MwsFinancesServiceException $se) {
            throw $se;
        } catch (\Exception $t) {
            throw new MwsFinancesServiceException(array('Exception' => $t, 'Message' => $t->getMessage()));
        }
    }
    /**
    ...
    private function _reportAnyErrors($responseBody, $status, $responseHeaderMetadata, \Exception $e = null)
    {
        ...
        return new MwsFinancesServiceException($exProps);
    }
    /**
    ...
    private function _httpPost(array $parameters)
    {
        ...
        if ($response === false) {
            ...
            curl_close($ch);
            throw new MwsFinancesServiceException($exProps);
        }
        curl_close($ch);
    ...
    private function _extractResponseHeaderMetadata($rawHeaders)
    {
        ...
        return new MwsFinancesServiceModelResponseHeaderMetadata($headers['x-mws-request-id'], $headers['x-mws-response-context'], $headers['x-mws-timestamp'], $headers['x-mws-quota-max'], $headers['x-mws-quota-remaining'], $headers['x-mws-quota-resetsOn']);
    }
    /**
