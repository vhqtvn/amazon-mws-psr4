...
use Vhqtvn\AmazonMWS\Services\FBAInventoryServiceMWS\Model\FbaInventoryServiceMwsModelGetServiceStatusRequest;
use Vhqtvn\AmazonMWS\Services\FBAInventoryServiceMWS\Model\FbaInventoryServiceMwsModelGetServiceStatusResponse;
use Vhqtvn\AmazonMWS\Services\FBAInventoryServiceMWS\Model\FbaInventoryServiceMwsModelListInventorySupplyRequest;
use Vhqtvn\AmazonMWS\Services\FBAInventoryServiceMWS\Model\FbaInventoryServiceMwsModelListInventorySupplyResponse;
use Vhqtvn\AmazonMWS\Services\FBAInventoryServiceMWS\Model\FbaInventoryServiceMwsModelListInventorySupplyByNextTokenRequest;
...
use Vhqtvn\AmazonMWS\Services\FBAInventoryServiceMWS\FbaInventoryServiceMwsException;
use Vhqtvn\AmazonMWS\Services\FBAInventoryServiceMWS\Model\FbaInventoryServiceMwsModelResponseHeaderMetadata;
/**
 * \Vhqtvn\AmazonMWS\Services\FBAInventoryServiceMWS\FbaInventoryServiceMwsClient is an implementation of FBAInventoryServiceMWS
 *
 */
class FbaInventoryServiceMwsClient implements FbaInventoryServiceMwsInterface
{
    ...
    /** @var array */
    private $_config = array('ServiceURL' => null, 'UserAgent' => 'FBAInventoryServiceMWS PHP5 Library', 'SignatureVersion' => 2, 'SignatureMethod' => 'HmacSHA256', 'ProxyHost' => null, 'ProxyPort' => -1, 'ProxyUsername' => null, 'ProxyPassword' => null, 'MaxErrorRetry' => 3, 'Headers' => array());
    /**
     * Get Service Status
     ...
     * @see \Vhqtvn\AmazonMWS\Services\FBAInventoryServiceMWS\Model\FbaInventoryServiceMwsModelGetServiceStatusRequest
    ...
    {
        if (!$request instanceof FbaInventoryServiceMwsModelGetServiceStatusRequest) {
            $request = new FbaInventoryServiceMwsModelGetServiceStatusRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'GetServiceStatus';
        $httpResponse = $this->_invoke($parameters);
        $response = FbaInventoryServiceMwsModelGetServiceStatusResponse::fromXML($httpResponse['ResponseBody']);
     ...
     * @see \Vhqtvn\AmazonMWS\Services\FBAInventoryServiceMWS\Model\FbaInventoryServiceMwsModelListInventorySupplyRequest
    ...
    {
        if (!$request instanceof FbaInventoryServiceMwsModelListInventorySupplyRequest) {
            $request = new FbaInventoryServiceMwsModelListInventorySupplyRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListInventorySupply';
        $httpResponse = $this->_invoke($parameters);
        $response = FbaInventoryServiceMwsModelListInventorySupplyResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
     ...
     * @see \Vhqtvn\AmazonMWS\Services\FBAInventoryServiceMWS\Model\FbaInventoryServiceMwsModelListInventorySupplyByNextTokenRequest
    ...
    {
        if (!$request instanceof FbaInventoryServiceMwsModelListInventorySupplyByNextTokenRequest) {
            $request = new FbaInventoryServiceMwsModelListInventorySupplyByNextTokenRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        $parameters['Action'] = 'ListInventorySupplyByNextToken';
        $httpResponse = $this->_invoke($parameters);
        $response = FbaInventoryServiceMwsModelListInventorySupplyByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    /**
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                throw new FbaInventoryServiceMwsException(array('ErrorCode' => 'InvalidServiceURL', 'Message' => "Missing serviceUrl configuration value. You may obtain a list of valid MWS URLs by consulting the MWS Developer's Guide, or reviewing the sample code published along side this library."));
            }
            ...
            throw new FbaInventoryServiceMwsException(array('Exception' => $t, 'Message' => $t->getMessage()));
        }
    }
    /**
    ...
    private function _reportAnyErrors($responseBody, $status, $responseHeaderMetadata, \Exception $e = null)
    {
        ...
        return new FbaInventoryServiceMwsException($exProps);
    }
    /**
    ...
    private function _httpPost(array $parameters)
    {
        ...
        if ($response === false) {
            ...
            curl_close($ch);
            throw new FbaInventoryServiceMwsException($exProps);
        }
        curl_close($ch);
    ...
    private function _extractResponseHeaderMetadata($rawHeaders)
    {
        ...
        return new FbaInventoryServiceMwsModelResponseHeaderMetadata($headers['x-mws-request-id'], $headers['x-mws-response-context'], $headers['x-mws-timestamp'], $headers['x-mws-quota-max'], $headers['x-mws-quota-remaining'], $headers['x-mws-quota-resetsOn']);
    }
    /**
